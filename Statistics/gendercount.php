      ...
      <div class="card mb-3">
        <div class="card-header">
          ...
          <div id="invalidResponse" style="text-align: center;"></div>
              <div class="row">
                <h4 class="col-lg-12 text-center">Total Student in School</h4>
              <div class="col-lg-6 col-md-6">
                <table class="table table-bordered">
                  <thead>
                    <tr>
                      <th colspan="2" rowspan="2"><center>Levels</center></th>
                      <th colspan="4"><center>Student</center></th>
                    </tr>
                    <tr>
                      <th>Male</th><th>Female</th><th>None</th><th>Total</th>
                    </tr>
                  </thead>
                  <tbody>
                    
                    <tr>
                      <td colspan="2">O'Level</td>
                      <td id="olvlMaleStd"></td>
                      <td id="olvlFemaleStd"></td>
                      <td id="olvlNoSexStd"></td>
                      <td id="olvlTotStd"></td>
                    </tr>
                    <tr>
                      <td colspan="2">A'Level</td>
                      <td id="alvlMaleStd"></td>
                      <td id="alvlFemaleStd"></td>
                      <td id="alvlNoSexStd"></td>
                      <td id="alvlTotStd"></td>
                    </tr>
                    <tr>
                      <td colspan="2">All</td>
                      <td id="wholeMaleStd"></td>
                      <td id="wholeFemaleStd"></td>
                      <td id="wholeNoSexStd"></td>
                      <td id="wholeTotStd"></td>
                    </tr>
                  </tbody>
                </table>
              </div>
              <div class="col-lg-6"> 
                <div id="graphPresent"> <canvas id="gender_count_statistics" style="height: 200px;"></canvas>
                </div>
              </div>
      </div>
    </div>
...
?>
  ...
  <script src="../js/chart.js"></script>
    ...
    <!-- Custom scripts for this page-->
     <script type="text/javascript" src="../js/web/index.js"></script> <script type="text/javascript" src="../Scripts/jqdepend.js"></script>
  </div>
</body>
  <script type="text/javascript">
    $(document).ready(function(){
    loadGenderStatistics('setContentByCount',"gender_count_statistics");
