  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="card mb-3">
       ...
       <div class=""> <canvas id="class_statistics" ></canvas></div>
      </div>
    </div>
    <!-- /.container-fluid-->
    <!-- /.content-wrapper-->
...
<!--
  ...
  <script type="text/javascript">
    loadClassStatistics('setContent','general','class_statistics');    
    function demoFromHTML() {
      $("#sidenavToggler").click();
    var pdf = new jsPDF('landscape');
    // source can be HTML-formatted string, or a reference
    // to an actual DOM element from which the text will be scraped.
    source = document.getElementById('class_statistics').toDataURL();
    pdf.addImage(source, 'PNG', 10, 40);
    pdf.text(10, 15, "Tutor Inspection System");
    pdf.text(10,23,$("#fullname").html())
    pdf.text(50,32,"General statistics graph for class' performance ");
    pdf.text(180,200," downloaded on "+getDate()+" at "+getTime());
    pdf.save($("#fullname").html()+' general classes performance.pdf');
      $("#sidenavToggler").click();
}
