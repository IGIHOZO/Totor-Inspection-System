...
$ntstt="Ny";
$mdstt="Md";
$sel_tasts=mysql_query("SELECT * FROM tis_tasks WHERE task_teacher='$tchr_id' AND task_xkul='$usr_id' AND task_type='$val_stts' AND ((task_status='$mdstt') OR (task_status='$ntstt'))");
...
<tr>
  ...
  <td>
    ...
    if ($ft_sel_tasts['task_status']=='Ny') {
      echo "<a href='task_marks.php?rei=$tsk_dtls' id='ntyt' >Not Yet</a>";
    }elseif ($ft_sel_tasts['task_status']=='Md') {

      echo "<a href='task_marks.php?rei=$tsk_dtls' id='mrkd'>Marked</a>";
    }
    ?>
  </td>
    <td>
...
$sel_llst=mysql_query("SELECT * FROM tis_tasks WHERE task_teacher='$tchr_id' AND task_xkul='$usr_id' AND ((task_status='$mdstt') OR (task_status='$ntstt'))");
