...
&nbsp;&nbsp;&nbsp;<br><br>
      ...
      <div class="form-group">
       ...
       <h4>List of Your Tests Available</h4>
...
$ntstt="Ny";
$mdstt="Md";
$sel_tasts=mysql_query("SELECT * FROM tis_tasks WHERE task_teacher='$tchr_id' AND task_xkul='$usr_id' AND task_type='testss' AND ((task_status='$mdstt') OR (task_status='$ntstt')) AND tis_tasks.task_date BETWEEN '".$calendarStart."' AND '".$calendarStop."' ORDER BY task_date DESC");
