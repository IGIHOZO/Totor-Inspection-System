...
require_once"../Classes/AcademicCalendar.php";
      ...
      $calendarStart=$calendar[0]['start'];$calendarStop=$calendar[0]['close'];require_once"../Classes/AcademicCalendar.php";
      $acal=new AcademicCalendar;
      $calendar=json_decode($acal->getAutomaticActiveCalendar(array("uid"=>$_SESSION['seveeen_tis_usr_id'])),TRUE);
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top" style="background-color: #000" style="position: absolute;">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
            ...
            <div class="modal-dialog">
                <div class="modal-content" style="padding: 20px;">
                    <div class="modal-header">
                         <h4 class="modal-title">New Exam registration form</h4>
      ...
      <input type="hidden" id="tskhddn" value="examss">
      <div class="form-group">
...
&nbsp;&nbsp;&nbsp;<br><br>
      ...
      <div class="form-group">
        <label>Exam Title</label><label style="margin-left: 6%;color: #f45;font-size: 14px;">&nbsp;(&nbsp; Maximum characters: <span style="color: #435344;font-weight: bolder"> 25 characters</span>)<label id="cnt_chr_resp"></label></label>
        <input type="text" class="form-control" oninput="return countTskTtlChrs()" id="tskttl" placeholder="Given Exam" maxlength="25">
      </div>
      <div class="form-group">
        ...
        <input type="number" class="form-control" id="tskovll" placeholder="" style="font-size: ">
                        ...
                        <div class="modal-footer"  style="margin-top: -30px;">
                            <button class="btn btn-primary" onclick="return setTsk()" id="sttsk"><span class="glyphicon glyphicon-ok"></span>&nbsp;&nbsp; Set Exam</button>
		...
		<div aria-hidden='true' aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="modalUpdateExam" class="modal fade">
            <div class='modal-dialog'>
                <div class="modal-content" style="padding: 20px;">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        <h4 class="modal-title">Update Exam form</h4>
                    </div>
                     <div class="modal-body">
      <div id="updExamResponse"></div>
          ...
          <?php
              ...
              echo "</select";
              ?></div>
      <input type="hidden" id="updtskhddn" value="examss">
      <div class="form-group">
        <label>Select Lesson</label>
...
&nbsp;&nbsp;&nbsp;<br><br>
      ...
      <div class="form-group">
        <label>Exam Title</label><label style="margin-left: 10%;color: #f45;font-size: 15px;">&nbsp;(&nbsp; Maximum characters: <span style="color: #435344;font-weight: bolder"> 25 characters</span>)<label id="updcnt_chr_resp"></label></label>
        <input type="text" class="form-control" oninput="return countTskTtlChrs()" id="tskttl" placeholder="Given Exam" maxlength="25">
      </div>
      <div class="form-group">
        <label>Overall marks</label>
        ...
        <div class="table">
                ...
                <button class="btn btn-primary glyphicon glyphicon-plus-sign pull-right" data-toggle='modal' data-target='#modalRegisterExam' style="margin-right:17px;"> New</button>
       <h4>List of Your Exams Available</h4>
        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" id="tblExams">
          <thead>
            <tr>
              <th>#Counts</th>
              <th>Class </th>
...
<button data-toggle="modal" data-target="#modalExam" class="btn btn-primary pull-right" style="margin-right:3%;margin-bottom:0.5%;margin-top: -1%"><span class="glyphicon glyphicon-plus"></span>Add Exams</button></th-->
            </tr>
          </thead>
          <tbody id="loadedexams">
		  <?php
$ntstt="Ny";
$mdstt="Md";
$sel_tasts=mysql_query("SELECT * FROM tis_tasks WHERE task_teacher='$tchr_id' AND task_xkul='$usr_id' AND task_type='examss' AND ((task_status='$mdstt') OR (task_status='$ntstt')) AND tis_tasks.task_date BETWEEN '".$calendarStart."' AND '".$calendarStop."' ORDER BY task_date DESC");
