...
<li><span class="form-inline my-2 my-lg-0 mr-lg-2" id="dte_grp"></div></li>
        </li>
      </ol>
      <!-- Example DataTables Card-->
      <div class="card mb-3" style="margin-top: -15px">
        <div class="card-header">
          <i class="fa fa-table"></i> Attach any document</div>
        <div class="card-body">
      ...
      <div class="card-body">
          <div class="form-group">
            <div class="form-row">
              <div class="col-md-6">
                <label for="protName">Document Name</label>
          ...
          <div class="form-group">
            <div class="form-row">
              <div class="col-md-6">
                <label for="protCategry">Attachments </label>
                <input type="file" id="subnewpss" class="form-control"><span class="glyphicon glyphicon-plus"></span>
              </div>
            </div>
          </div>
          <button disabled class="btn btn-primary btn-block"  id="ssuubb" onclick="addSubUsr()"><span class="glyphicon glyphicon-saved"></span>&nbsp&nbsp Add</button>
      </div>
          </div>
        </div>
    ...
    <!-- /.content-wrapper-->
<div style="margin-left: 10.87%;position: relative;">
<?php
