    ...
    <div class="container-fluid">
      ...
      <!-- Example DataTables Card-->
          <div class="form-group">
            <div class="form-row">
              <div class="col-md-12">
                <h2 align="center" class="list-group-item" id="crt_nw_cl_ttl">Re-Orient Teacher</h2>
  ...
  <table id="new_cls_tbl" class="table table-responsive">
    ...
    <tbody>
      <tr>
        ...
        <td>
          <span class="form-group">
          <button class="btn btn-success" id="okset" onclick="return reOrientTchr()"><span class="glyphicon glyphicon-ok"></span>&nbsp&nbsp&nbsp Re-orient</button> 
         </span>
        </td>
      </tr>
    </tbody>
