...
<head>
  ...
  <title>Orient Teacher | Tutor Inspection System</title>
<style>
.loader01 {
    ...
    <div class="container-fluid">
      ...
      <!-- Example DataTables Card-->
          <div class="form-group">
            <div class="form-row">
              <div class="col-md-12">
                <h2 align="center" class="list-group-item" id="crt_nw_cl_ttl">Orient Teacher</h2>
      ...
      <tr>
        <td>
          <span class="form-group">
              ...
              <?php
              echo "<select class='form-control' id='or_tch_tchr'>";
        ...
        <td>
          <span class="form-group">
          <button class="btn btn-success" id="okset" onclick="return orientTchr()"><span class="glyphicon glyphicon-ok"></span>&nbsp&nbsp&nbsp Ok set</button> 
         </span>
        </td>
      </tr>
    </tbody>
