...
<div class="input-group"><label for="lblefrom"><b>&nbsp;Choose Day: &nbsp </b></label><input type="text" name="lblefrom" id="lblefrom" class="form-control" placeholder="Month / Day / Year"><button class="btn btn-primary" id="tke_btn" onclick="return gnTskDatPckr()"><span class="glyphicon glyphicon-check"></span>&nbsp;&nbsp;Take...</button></div></div></li>
        </li>
      </ol>
      ...
      <div class="card mb-3">
        ...
        <div class="card-body">
          <div class="table-responsive" id="tbltask">
...
$("#footerlg").hide();
$("#reportBody").html($("#tbltask").html());
$("#schoolName").html($("#fullname").html());
$("#reportTitle").html("Given Task ");
$("tfoot").hide();
window.print();
$("#reportBody").html("");
$("#reportTitle").html("");
